...
export default function StatsBar({ matchCount, totalEntries, fpRateEstimate, precision, recall }) {
  ...
  return (
    <div className="bg-surface border border-gray-800 rounded-lg p-4 grid grid-cols-2 md:grid-cols-4 gap-4 glow-border">
      <div className="bg-background/40 border border-gray-800/80 rounded p-3 text-center hover:scale-[1.02] transition-transform duration-300">
